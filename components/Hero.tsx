  ...
  return (
    <section id="top" className="py-12 lg:py-16">
      <div className="rounded-3xl bg-white/80 p-8 shadow-card ring-1 ring-primary/5 sm:p-10">
        ...
        <p className="mb-6 max-w-3xl text-lg text-slate-700">
          Barehall rental only—every booking includes exclusive access to the
          hall, tables, chairs, kitchen, and sparkling clean restrooms. You
          bring your dream menu, bar service, and decorations to make the space
          yours.
        </p>
