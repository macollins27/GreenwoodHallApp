...
INSERT INTO "new_Booking" ("baseAmountCents", "bookingType", "contactEmail", "contactName", "contactPhone", "contractAccepted", "contractAcceptedAt", "contractSignerName", "createdAt", "dayType", "depositCents", "endTime", "eventDate", "eventHours", "eventType", "extraSetupCents", "extraSetupHours", "guestCount", "hourlyRateCents", "id", "notes", "startTime", "status", "totalCents", "updatedAt") SELECT "baseAmountCents", "bookingType", "contactEmail", "contactName", "contactPhone", "contractAccepted", "contractAcceptedAt", "contractSignerName", "createdAt", "dayType", "depositCents", "endTime", "eventDate", "eventHours", "eventType", "extraSetupCents", "extraSetupHours", "guestCount", "hourlyRateCents", "id", "notes", "startTime", "status", "totalCents", "updatedAt" FROM "Booking";
DROP TABLE "Booking";
